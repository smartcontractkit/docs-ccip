...
async function main() {
  ...
  console.log("");
  console.log("========================================");
  console.log("⚙️ Configure CCIP Messenger Contracts on Both Chains");
  console.log("========================================");
  ...
  console.log(
    `SOURCE_CHAIN=${sourceChainName} DEST_CHAIN=${destChainName} FEE_TOKEN=LINK GAS_LIMIT=200000 ${finalityHint} MESSAGE='Hello World From Hardhat Script for CCIP 2.0!' npx hardhat run hardhat/scripts/tutorials/send-arbitrary-data/interact/send-message.ts`
  );
  console.log("");
  console.log("Or send a message paying with native gas (default):");
  console.log(
    `SOURCE_CHAIN=${sourceChainName} DEST_CHAIN=${destChainName} GAS_LIMIT=200000 ${finalityHint} MESSAGE='Hello World From Hardhat Script for CCIP 2.0!' npx hardhat run hardhat/scripts/tutorials/send-arbitrary-data/interact/send-message.ts`
  );
  console.log("========================================");
  console.log("");
}
