...
async function main() {
  ...
  console.log("");
  console.log("========================================");
  console.log("🚀 Deploy CCIP Defensive Contracts on Both Chains");
  console.log("========================================");
  ...
  console.log(`\n[Step 1] Deploying ProgrammableDefensiveTokenTransfers on ${sourceConfig.chainName}`);
  ...
  console.log(`\n[Step 2] Deploying ProgrammableDefensiveTokenTransfers on ${destConfig.chainName}`);
