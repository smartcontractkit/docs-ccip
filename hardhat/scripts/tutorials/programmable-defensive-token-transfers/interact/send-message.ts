...
async function main() {
  ...
  console.log("");
  console.log("========================================");
  console.log(`📡 CCIP Defensive Message Transfer - Pay with ${feeTokenSymbol}`);
  console.log("========================================");
  ...
  console.log(`CHAIN=${destChainName} npx hardhat run hardhat/scripts/tutorials/programmable-defensive-token-transfers/interact/get-failed-messages.ts`);
  console.log("");
  console.log("To recover tokens from a failed message:");
  console.log(`MESSAGE_ID=<id> TOKEN_RECEIVER=<address> CHAIN=${destChainName} npx hardhat run hardhat/scripts/tutorials/programmable-defensive-token-transfers/interact/retry-failed-message.ts`);
}
