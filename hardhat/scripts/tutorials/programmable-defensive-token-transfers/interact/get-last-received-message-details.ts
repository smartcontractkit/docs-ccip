...
async function main() {
  ...
  console.log("");
  console.log("========================================");
  console.log("🔍 Verify Received Message (Defensive)");
  console.log("========================================");
  ...
  const [messageId, sender, text, tokenAddress, tokenAmount] = details;
  ...
  console.log(`Received Token: ${tokenAddress}`);
  console.log(`Received Token Amount: ${tokenAmount}`);
  console.log("========================================");
  console.log("");
}
