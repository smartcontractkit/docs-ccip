...
contract Deploy is Script {
    ...
    function run() external {
        ...
        console.log("");
        console.log("========================================");
        console.log(unicode"🚀 Deploy CCIP Defensive Contracts on Both Chains");
        console.log("========================================");
        ...
        // Deploy ProgrammableDefensiveTokenTransfers
        console.log(
            string.concat(
                "\n[Step 1] Deploying ProgrammableDefensiveTokenTransfers on ", helperConfig.getChainName(sourceChainId)
            )
        );
        ProgrammableDefensiveTokenTransfers contractInstanceOnSourceChain =
            new ProgrammableDefensiveTokenTransfers(sourceConfig.router);
        ...
        console.log(
            string.concat(
                "\n[Step 2] Deploying ProgrammableDefensiveTokenTransfers on ", helperConfig.getChainName(destChainId)
            )
        );
        ProgrammableDefensiveTokenTransfers contractInstanceOnDestChain =
            new ProgrammableDefensiveTokenTransfers(destConfig.router);
